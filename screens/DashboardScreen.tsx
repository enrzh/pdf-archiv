...
export const DashboardScreen: React.FC<DashboardScreenProps> = ({ files, onNavigate, onFileSelect, onExport, onDelete, onToggleRead, lang, categories }) => {
    ...
    return (
        <div className="min-h-screen bg-background text-gray-100 pb-24 animate-fade-in flex flex-col h-full transition-colors duration-300 relative">
            ...
            {/* Uploads List */}
            <div className="px-4 mt-4 flex-1 overflow-y-auto pb-24">
            ...
            <button 
                ...
                className="fixed right-6 bottom-28 size-16 bg-primary rounded-[24px] shadow-glow text-background flex items-center justify-center active:scale-95 transition-all z-40 hover:scale-105 hover:brightness-110"
            >
